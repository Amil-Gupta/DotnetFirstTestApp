...
namespace TestApp.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public LecturersController(TestAppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Lecturers != null ? 
                          ...
                          Problem("Entity set 'TestAppDbContext.Lecturers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Firstname,Lastname")] Lecturer lecturer)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TestAppDbContext.Lecturers'  is null.");
            }
            var lecturer = await _context.Lecturers.FindAsync(id);
            if (lecturer != null)
            {
